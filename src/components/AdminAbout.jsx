...
function AdminAbout() {
  ...
  function handleEditSubmit(e) {
    ...
    setSubmitting(true);
    About.patchAboutPartialId(id, data);
  ...
  return (
    <>
      ...
      <section className="p-10">
        ...
        <div className="mt-10">
          <h2 className="text-center text-[30px] mb-5">Aboutlar</h2>

          <div className="flex flex-wrap gap-4 items-center justify-between">
            {about.map((item) => {
              return (
                <div key={item.id}>
                  <div className="w-[300px] h-[164px] justify-between rounded-[16px] gap-4 flex flex-col bg-[#1A1A2E] pt-6 pb-6 pl-6 pr-6">
